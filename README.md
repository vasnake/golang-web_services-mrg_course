...
- Тестирование функций хендлера, `httptest.NewRequest`, `httptest.NewRecorder`, `go test ...`.
- Тестирование фунцкии зависящей от внешнего сервиса, мокать внешний сервис.
