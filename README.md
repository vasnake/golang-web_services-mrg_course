...
- Обработка трех роутов тремя хендлерами, два из них -- анонимные функции.
- Хендлеры как структуры, реализующие интерфейс. Параметризуемые хендлеры, обладающие внутренним состоянием.
- Отдельно конфигурируется мультиплексор обработчиков роутов и отдельно конфигурируется сервер. Или несколько серверов.
...
- Как считать параметры из объекта риквест.
