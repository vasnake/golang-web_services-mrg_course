...
const (
	AuthChecker_Create_FullMethodName = "/grpc_5_gateway.AuthChecker/Create"
	AuthChecker_Check_FullMethodName  = "/grpc_5_gateway.AuthChecker/Check"
	AuthChecker_Delete_FullMethodName = "/grpc_5_gateway.AuthChecker/Delete"
)
...
var AuthChecker_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc_5_gateway.AuthChecker",
