...
const (
	AuthChecker_Create_FullMethodName = "/grpc_4_balanced.AuthChecker/Create"
	AuthChecker_Check_FullMethodName  = "/grpc_4_balanced.AuthChecker/Check"
	AuthChecker_Delete_FullMethodName = "/grpc_4_balanced.AuthChecker/Delete"
)
...
var AuthChecker_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc_4_balanced.AuthChecker",
