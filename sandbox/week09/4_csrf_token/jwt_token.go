...
type JwtCsrfClaims struct {
	...
	jwt.StandardClaims        // validity check
}

// csrf token interface implementation
type JwtToken struct {
	Secret []byte // token signature key
}
...
// unpack token, check signature, check session id and user id
