...
- [mux](week_04/mux.go) Более низкоуровневое API к веб-серверу, больше возможностей для настройки.
...
- [server_test](week_04/server_test.go) Тестирование функций зависящих от внешнего сервиса:
...
Начало изучения "чего же от нас требуется": `handouts\golang_web_services_2023-12-28.zip\4\99_hw\readme.md`
...
- `dataset.xml` - файл с данными, в нем сервер (несуществующий) будет искать
...
Покрыть тестами метод `FindUsers`, 100%. Тесты писать "по взрослому", не игрушечные.
