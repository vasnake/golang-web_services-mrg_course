...
func startServer() { // async, run the server
...
func main() {
	go startServer() // async service

	time.Sleep(100 * time.Millisecond)

	runGet()              // ask service using get
	runGetFullReq()       // ask service with low-level get API
	runTransportAndPost() // ask service using post and very low-level API
}
