...
Два слоя: слой хранилища, где лежат данные конфига в виде key-value (http://localhost:8500/ui/dc1/kv);
слой использования и обновления конфига: конфиг как глобальная мапка в виде референса,
под защитой мютекса реф. переключается на новую версию мапки. Новая версия создается при апдейте версии в хранилище.
