...
type PersonalAccount struct {
	...
	Cleaner func(string) string // func as struct fiekd
	Owner   Person              // struct as field
	Person                      // Account id, name and address
}
...
func main() {
	...
	var acc Account = Account{
		Id:   42,
		Name: "foo",
	} // remember: default values for unset fields
	...
	fmt.Printf("Account with owner: %#v\n", pa)
	// Account with owner: main.PersonalAccount{Id:77, Name:"baz", Cleaner:(func(string) string)(nil), Owner:main.Person{Id:0, Name:"", Address:""}, Person:main.Person{Id:0, Name:"", Address:"Far Far Away"}}
